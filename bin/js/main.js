...
Main.main = function() {
	Tests.Run();
	haxe_Log.trace("Haxe is great!",{ fileName : "src/Main.hx", lineNumber : 8, className : "Main", methodName : "main"});
};
Math.__name__ = "Math";
...
TestStuff.__name__ = "TestStuff";
TestStuff.__super__ = utest_Test;
TestStuff.prototype = $extend(utest_Test.prototype,{
	foo: null
	,testMyClassWithBar: function() {
		this.foo = new stuff_MyClass();
		var bar = "bar";
		this.foo.MyField = bar;
		utest_Assert.equals(bar,this.foo.MyField,null,{ fileName : "src/Tests.hx", lineNumber : 24, className : "TestStuff", methodName : "testMyClassWithBar"});
	}
	,__initializeUtest__: function() {
		var _gthis = this;
		var init = utest_Test.prototype.__initializeUtest__.call(this);
		init.tests.push({ name : "testMyClassWithBar", execute : function() {
			_gthis.testMyClassWithBar();
...
var stuff_IMyInterface = function() { };
stuff_IMyInterface.__name__ = "stuff.IMyInterface";
stuff_IMyInterface.__isInterface__ = true;
stuff_IMyInterface.prototype = {
	MyField: null
	,__class__: stuff_IMyInterface
};
var stuff_MyClass = function() {
	haxe_Log.trace("A new MyClass instance was created!",{ fileName : "src/stuff/MyClass.hx", lineNumber : 8, className : "stuff.MyClass", methodName : "new"});
};
stuff_MyClass.__name__ = "stuff.MyClass";
stuff_MyClass.__interfaces__ = [stuff_IMyInterface];
stuff_MyClass.prototype = {
	MyField: null
	,__class__: stuff_MyClass
};
